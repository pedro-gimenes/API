package com.pedroAntonin.todosimple.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler imlpements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object> HandleConstraintViolationException(
            ...
            WebRequest request) {
        log.error("Failed to validated element", constraintViolationException);
